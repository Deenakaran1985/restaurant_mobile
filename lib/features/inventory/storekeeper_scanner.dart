  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Storekeeper Raw Material Scanner & Audits', style: GoogleFonts.outfit(fontWeight: FontWeight.bold)),
        actions: [
          IconButton(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(it['name'], style: GoogleFonts.outfit(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                            Text('Cost: ₹${it['cost']} / ${it['unit']}', style: TextStyle(color: AppTheme.slateGray, fontSize: 14)),
                          ],
                        ),
                        Row(
                          children: [
                            Column(
                              ...
                              children: [
                                Text('${it['stock']} ${it['unit']}', style: GoogleFonts.outfit(color: isLow ? AppTheme.accentCrimson : AppTheme.primaryEmerald, fontSize: 24, fontWeight: FontWeight.w800)),
                                Text('Min Alert: ${it['min']} ${it['unit']}', style: TextStyle(color: AppTheme.slateGray, fontSize: 13)),
                              ],
                            ),
                            const SizedBox(width: 20),
                            IconButton(
